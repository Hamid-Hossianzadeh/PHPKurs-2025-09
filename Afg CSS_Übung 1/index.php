...
$logoText	= $this->params->get("logoText","WINTER3R");
$logoFontsize	= $this->params->get("logoFontsize", "39");
...
$searchPosition	= $this->params->get("searchPosition", "30");
$topmenuPosition = $this->params->get("topmenuPosition", "5");
$slideshowPosition = $this->params->get("slideshowPosition", "5");
if($this->countModules('position-0')) {
	$searchWidth = 3;
} else {
	$searchWidth = 0;
}
$sociWidth = 12 - $searchWidth - $logoWidth;
			...
			<div id="headerright" class="span<?php echo $headerrightWidth; ?>">
				<div id="hsocial" class="row">
					<?php if($this->countModules('position-0')) : ?>
						<div id="search" class="span<?php echo $searchWidth; ?> pull-right clearfix">
